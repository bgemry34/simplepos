...
<div class="row">
    ...
    <div class="col-md-2">
    <p style="text-align: center;"><strong>UserType</strong></p>
    </div>
    <div class="col-md-1">
...
<div class="row">
		...
		<div class="col-md-3 card">
        <p style="text-align: center;"><?=$item['password'];?></p>
    	</div>
    	<div class="col-md-2 card">
        <p style="text-align: center;"><?=$item['usertype'];?></p>
		</div>
		<!-- delete -->
		<div class="col-md-1" style="padding:0; margin-left:2.5px;">
		<?=form_open('users/delete_user')?>
		<input type="hidden" name="id" value="<?=$item['id']?>">
		<button class="btn btn-danger w-100" type="submit"><i class="fa fa-trash" aria-hidden="true"></i></button>
        </div>
</div>
<?php endforeach; ?>
</div>
