...
<div class="row">
    ...
    <div class="col-md-2">
        <p style="text-align: center;"><strong>Restore</strong></p>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-md-2 card">
		...
		<!-- edit -->
    	<div class="col-md-2" style="padding:0; margin-left:5px;">
        <?=form_open('items/item_recovered')?>
			<input type="hidden" name="itemId" value="<?=$item['id']?>">
			<button type="submit" class="btn btn-success w-50 m-auto d-block">
